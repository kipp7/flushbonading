...
1. [x] 001: Inventory implemented features vs OpenSpec changes (core + devtools).
...
4. [x] 004: Decide archival plan for the two existing changes after verification.
5. [x] 005: Create base specs under openspec/specs/ for core capabilities (if missing).
6. [x] 006: Create base specs under openspec/specs/ for devtools capabilities (if missing).
7. [x] 007: Add traceability map (features -> modules -> specs).
8. [x] 008: Write TECH_STACK.md with exact versions and toolchain.
9. [x] 009: Write ARCHITECTURE.md with module boundaries and data flow.
...
13. [x] 013: Add React error boundary with a friendly fallback.
14. [x] 014: Add a lightweight toast/notice component for import/export feedback.
15. [ ] 015: Add a logging utility for allocator/import/export debug.
16. [x] 016: Add persistent UI settings store (local only).
17. [x] 017: Add reset-to-defaults action for settings.
18. [x] 018: Add an About panel with version/build info.
19. [x] 019: Add a simple diagnostics panel (runtime env, file paths).
20. [x] 020: Add design tokens (CSS variables) for core colors/spacing.
21. [ ] 021: Add types for settings + feature flags in src/types.ts.
22. [x] 022: Add docs for data schema (MCU, sensor, constraint).
23. [x] 023: Add docs for export file formats and naming rules.
24. [x] 024: Add docs for project file format and versioning.
25. [x] 025: Add contributor onboarding notes (local dev, Tauri).
26. [x] 026: Add regression checklist doc (allocator + layout).
27. [x] 027: Add offline verification notes to docs (no network calls).
28. [x] 028: Add release checklist doc (manual QA, build outputs).
...
31. [x] 031: Add catalog schema version field to import templates.
32. [x] 032: Update sensor JSON template to include schema/version metadata.
33. [x] 033: Update sensor CSV template to include schema/version metadata.
34. [x] 034: Update MCU JSON template to include schema/version metadata.
35. [x] 035: Update MCU CSV template to include schema/version metadata.
36. [x] 036: Update constraint JSON template to include schema/version metadata.
37. [x] 037: Add JSON validation for sensor catalogs.
38. [x] 038: Add JSON validation for MCU catalogs.
39. [x] 039: Add JSON validation for constraint catalogs.
40. [x] 040: Improve CSV parser (quoted fields, escaped commas).
41. [ ] 041: Add parser tests or scripted checks for CSV edge cases.
42. [x] 042: Add import preview table for sensor catalogs.
43. [x] 043: Add import preview table for MCU catalogs.
44. [x] 044: Add import preview for constraints.
45. [x] 045: Add merge/replace toggle for sensor imports.
46. [x] 046: Add merge/replace toggle for MCU imports.
47. [x] 047: Add replace-only flow for constraint imports.
48. [ ] 048: Add duplicate ID resolver UI (rename/skip).
49. [x] 049: Add import summary (counts + errors).
50. [x] 050: Add import error list panel with row-level messages.
51. [x] 051: Add export of current sensor catalog to JSON.
52. [x] 052: Add export of current sensor catalog to CSV.
53. [x] 053: Add export of current MCU catalog to JSON.
54. [x] 054: Add export of current MCU catalog to CSV.
55. [x] 055: Add export of current constraint catalog to JSON.
...
60. [x] 060: Add saved catalog persistence (custom MCUs/sensors/constraints).

## Phase 03 - Constraint System (061-090)
61. [x] 061: Draft OpenSpec proposal for constraint editor + overrides.
62. [x] 062: Extend PinConstraint model (enabled, severity, source).
63. [x] 063: Add constraint editor list (enable/disable).
64. [x] 064: Add constraint add/edit dialog.
65. [x] 065: Add constraint delete/restore defaults.
66. [x] 066: Add per-project constraint overrides (saved in project file).
67. [ ] 067: Add UI toggle for project vs global constraints.
68. [x] 068: Add soft constraint severity and warning view.
69. [x] 069: Add SWD rule toggle per project.
70. [x] 070: Add BOOT/NRST rules per MCU series.
71. [x] 071: Add oscillator (HSE/LSE) rules per MCU series.
...
75. [x] 075: Add constraint packs per MCU series.
76. [x] 076: Add constraint import validation for new fields.
77. [x] 077: Add constraint export to JSON (with schema/version).
...
83. [x] 083: Add manual pin reserve list (constraint-backed).
...
88. [x] 088: Add ability to temporarily disable a constraint in UI.
89. [x] 089: Add localization strings for new constraint UI.
90. [ ] 090: Update docs/ROADMAP and docs/BACKLOG for constraint progress.

## Phase 04 - Allocation Intelligence (091-120)
91. [x] 091: Draft OpenSpec proposal for planning intelligence rules.
92. [x] 092: Add I2C address metadata to sensor models.
93. [x] 093: Add I2C address collision detection.
94. [x] 094: Add UI warnings for I2C address conflicts.
95. [ ] 095: Add SPI CS budget check (max CS pins per bus).
96. [ ] 096: Add UI hints when CS budget exceeded.
97. [x] 097: Add UART exclusivity check (one device per UART).
...
101. [x] 101: Add allocator deterministic ordering guarantee.
...
105. [x] 105: Add tests or scripted checks for new rules.
...
116. [x] 116: Add OpenSpec scenarios for new allocation rules.
...
120. [x] 120: Update regression checklist for allocator changes.

## Phase 05 - Canvas + UX (121-160)
121. [x] 121: Add canvas zoom controls.
122. [x] 122: Add canvas pan controls.
123. [ ] 123: Add reset-view button.
124. [x] 124: Add sensor auto-position by closest pins.
125. [x] 125: Add sensor orientation controls (left/right/top/bottom).
...
130. [x] 130: Add wire hover highlight and focus.
131. [x] 131: Add pin hover highlight across MCU/sensor.
...
137. [x] 137: Add subtle board texture/background choices.
...
142. [x] 142: Add pin tooltip with alternate functions list.
...
161. [x] 161: Draft OpenSpec proposal for codegen + export expansion.
162. [ ] 162: Add SPL GPIO init per pin function (input/output/AF).
163. [x] 163: Add SPL bus init parameters per speed preset.
164. [x] 164: Add SPL I2C read/write helper stubs.
...
169. [x] 169: Add hardware export CSV: pin usage.
170. [x] 170: Add hardware export CSV: wiring list.
171. [x] 171: Add hardware export CSV: BOM.
172. [x] 172: Add export bundle (zip) with all outputs.
173. [ ] 173: Add export naming presets (project name).
174. [x] 174: Add constraint export to JSON (if not already).
...
179. [x] 179: Add export metadata file (schema version, timestamp).
180. [x] 180: Add UI panel for export options (format selection).
...
189. [x] 189: Add export success toast with file names.
190. [x] 190: Update README/docs for new outputs.
