# Capability: Pin Constraints

## Purpose
Protect critical and reserved pins (for example SWD, BOOT, oscillator pins) and provide a locally configurable constraint set that the allocator can enforce offline.

## Requirements

### Requirement: Critical Pin Constraints
The system SHALL enforce critical pin constraints (for example SWD, BOOT, oscillator pins) and mark conflicts when allocations violate them.
