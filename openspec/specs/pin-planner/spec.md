# Capability: Pin Planner

## Purpose
Define the core user flows for selecting an MCU and sensors, allocating pins, visualizing wiring, and exporting artifacts in an offline-first desktop workflow.

## Requirements

### Requirement: MCU Selection and Pin Map
The system SHALL allow the user to select an MCU and render its pin map with pin labels and reserved and power markings.
...
The system SHALL generate starter code using the STM32 Standard Peripheral Library based on the current pin allocation.
