# Capability: SPL Code Generation

## Purpose
Generate STM32 Standard Peripheral Library (SPL) starter C templates from the current allocation to accelerate firmware bring-up without generating HAL or LL code.
...
- **THEN** the output contains SPL only symbols and includes no HAL or LL headers or APIs
