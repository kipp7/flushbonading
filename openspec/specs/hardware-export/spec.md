# Capability: Hardware Export

## Purpose
Export practical hardware planning artifacts (pin usage, wiring list, BOM summary) locally so the output can be consumed in board bring-up and documentation workflows.
